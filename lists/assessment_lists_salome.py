...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    foods_in_common_set = foods1_set & foods2_set
    foods_in_common = list(foods_in_common_set)
...
def largest_n_items(items, n):
    ...
    n_largest = []
    for i in range(len(sorted_items)-n, len(sorted_items)):
        n_largest.append(sorted_items[i])
